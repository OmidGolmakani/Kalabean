...
namespace Kalabean.API.Migrations
{
    ...
    [Migration("20210918194646_AddTargetTypeIdToProductAndReqirement")]
    partial class AddTargetTypeIdToProductAndReqirement
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kalabean.Domain.Entities.Favorites", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Kalabean.Domain.Entities.TargetType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Kalabean.Domain.Entities.City", b =>
                {
                    b.HasOne("Kalabean.Domain.Entities.City", "Parent")
                        .WithMany("Child")
                        .HasForeignKey("ParentId");
            ...
            modelBuilder.Entity("Kalabean.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("Kalabean.Domain.Entities.TargetType", "TargetType")
                        .WithMany("Products")
